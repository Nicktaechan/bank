    ...
    for name in all_accounts:
        if name == login_name:
            ...
            if login_password == password:
                ...
                Button(account_dashboard, text="Ministatement", font=('Calibri',12),width=30, command=ministatement).grid(row=5,sticky=N,padx=10)
...
def deposit():
    ...
    current_balance_label = Label(deposit_screen, text="current balance : ksh" + details_balance, font=('Calibri',12))
    ...
    #Buttons
    Button(deposit_screen, text="Finish", font=('Calibri',12), command=finish_deposit).grid(row=3,sticky=W,pady=10)
...
def withdraw():
    ...
    current_balance_label = Label(withdraw_screen, text="current balance : ksh" + details_balance, font=('Calibri',12))
    current_balance_label.grid(row=1,sticky=W)
    ...
    #Buttons
    Button(withdraw_screen, text="Finish", font=('Calibri',12), command=finish_withdraw).grid(row=3,sticky=W,pady=10)
...
def personal_details():
    ...
    Label(personal_details_screen, text="Balance : ksh" + details_balance, font=('Calibri',12)).grid(row=4,sticky=W)
...
def login():
    ...
    #Buttons
    Button(login_screen, text="Login", command=login_session, width=15, font=('Calibri',12)).grid(row=3,sticky=W,pady=10,padx=5)
